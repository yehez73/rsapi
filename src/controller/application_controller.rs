...
use crate::{models::application, service::application_service};
...
pub async fn add_application(pool: web::Data<sqlx::PgPool>, application: web::Json<crate::models::application::Application>) -> impl Responder {
...
pub async fn update_application(pool: web::Data<sqlx::PgPool>, application: web::Json<crate::models::application::Application>, id: web::Path<uuid::Uuid>) -> impl Responder {
